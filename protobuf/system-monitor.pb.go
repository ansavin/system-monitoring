...
type FsStats struct {
	...
	Name         string  `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Bytes        float64 `protobuf:"fixed64,2,opt,name=bytes,proto3" json:"bytes,omitempty"`
	BytesPercent float64 `protobuf:"fixed64,3,opt,name=bytesPercent,proto3" json:"bytesPercent,omitempty"`
	Inode        float64 `protobuf:"fixed64,4,opt,name=inode,proto3" json:"inode,omitempty"`
...
func (x *FsStats) GetBytes() float64 {
	if x != nil {
		return x.Bytes
	}
	return 0
...
func (x *FsStats) GetInode() float64 {
	if x != nil {
		return x.Inode
	}
	return 0
...
var file_protobuf_system_monitor_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x62,
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x69, 0x6e, 0x6f, 0x64, 0x65, 0x12, 0x22,
